<template>
  ...
  >
    <div class="auth__form-field">
      <label
        class="auth__form-label auth__form-block-avatar"
        for="avatar"
      >
        <input
          id="avatar"
          class="auth__form-file input__file"
          type="file"
        ...
        <span
          v-if="!avatar.src"
          class="auth__form-file-style input__file-style"
        >
          Загрузить фотографию
        </span>
        <img
          v-if="avatar.src"
          class="auth__form-avatar"
          :src="avatar.src"
          alt=""
        >
      </label>
    ...
    <div class="auth__form-field">
      <label
        ...
        for="username"
      >
        <h4 class="auth__form-field-title">Имя пользователя</h4>
        <input
          id="username"
    ...
    <div class="auth__form-field">
      <label
        ...
        for="repeatPassword"
      >
        <h4 class="auth__form-field-title">Повторить пароль</h4>
        <input
          id="repeatPassword"
